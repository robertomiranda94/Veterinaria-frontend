    ...
    <>
      ...
      <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
        ...
        <div className="my-5">
          ...
          <input type="submit" value={"Crear Cuenta"} className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:bg-indigo-800 md:w-auto" />
        </form>
